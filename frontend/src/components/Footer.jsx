    ...
    return (
        <div style={{padding: "12px 0px", backgroundColor : "white", textAlign: 'center', position:'fixed', width: '100%',height : '85px', bottom : '0', left: '0', right: '0', zIndex : '999'}}>
            ...
            <div className="text-center pt-1">
                ...
                <a href="https://mail.google.com/mail/u/3/#inbox/" target="_blank" rel="noreferrer">
                    <i className="bi bi-globe mx-2" style={{fontSize : "20px"}}></i>
                </a>

                <a href="https://github.com/ManiBasel/MK" target="_blank" rel="noreferrer">
                    <i className="bi bi-github mx-2" style={{fontSize : "21px"}}></i>
                </a>

                <a href="mailto:manibasel28@gmail.com" target="_blank" rel="noreferrer">
